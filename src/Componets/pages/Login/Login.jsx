...
const Login = () => {
  ...
  return (
    <div
      className="flex justify-center items-center h-screen bg-cover bg-center animate__animated  animate__fadeInLeft"
      style={{
        backgroundImage:
    ...
    >
      <Helmet>
        <title>Sanctuary Real Estate | Log In</title>
      </Helmet>
      {toast && <Toast message={toast.message} isSuccess={toast.isSuccess} />}
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="animate__animated animate__fadeInBottomRight bg-white bg-opacity-20 backdrop-blur-lg p-10 rounded-xl shadow-lg  min-w-96"
      >
        ...
        <div className="flex justify-center items-center flex-wrap gap-5">
          <button className="btn" onClick={handleGoogleRedirect}>
            <img src="/google.png" alt="" className="h-10" />
          </button>
