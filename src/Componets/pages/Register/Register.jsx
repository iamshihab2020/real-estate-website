...
const Register = () => {
  ...
  return (
    <div className="animate__animated  animate__fadeInRight flex items-center justify-center py-0 md:py-16 lg:py-16 px-0  md:px-16 lg:px-16 rounded-3xl  bg-[url('https://cdn.pixabay.com/photo/2022/05/22/17/22/building-7214070_1280.jpg')] bg-cover bg-center">
      <Helmet>
        <title>Sanctuary Real Estate | Register</title>
      </Helmet>
      {toast && <Toast message={toast.message} isSuccess={toast.isSuccess} />}

      <form
        onSubmit={handleSubmit(onSubmit)}
        className="animate__animated animate__fadeInBottomLeft w-96 py-10 px-10 rounded-3xl flex flex-col items-center justify-center bg-white/30 backdrop-blur-lg bg-opacity-20 shadow-lg"
      >
        <div>
        ...
        <label className="label">
          <p className="label-text-alt ">
            ...
            <Link
              to={`/login`}
              className="link link-hover text-green-500 font-bold"
            >
              Log In
            </Link>
          </p>
